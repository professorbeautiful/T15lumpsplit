---
Title: RTutor Example interactive Problemset, towards the T15
Author:   modified by R.Day--SebastianKranz
Date:   "`Sys.date()`"
---
...
library(RTutor)
### Use Knit option "Document Directory" .
#setwd(system.file(package="RTutor", "examples") )
#setwd(system.file(package="T15lumpsplit", "examples") )
ps.name = "T15lumpsplit-tutor"
sol.file = "T15lumpsplit-tutor.Rmd"
