...
We have a nuisance parameter all right: 
$\phi$,     whose opinion is right, either $Split$ or $Lump$.
...
<a href="https://www.youtube.com/watch?v=c2IXn-rBl6k"> 
"Episode 3: ***Dose Utility Explorer***, a "shiny" app. Expected Utility with Meihua Marie & Devlish Merry" </a>   
Yes, there's an <a href="https://trials.shinyapps.io/DUEshiny/"> app </a> for that. 

***Sidebar***:  
`r actionButton(class='sidebar', inputId='DrWho_prior_notation', label =  'Dr. Who\'s notation for prior and posterior probability' )`  
```{r}
