...
NOTE: This marginalizes out (sums over) the nuisance parameter $\phi$ over the joint distribution of ( ${p_{R.D}},\phi$)!  For details on Bayes Theorem, including conditioning and marginalizing, see here:


```{r hide=TRUE}
interactiveSection(codeToRun="eval(parse(text=linkout(
                   'bayes_decision_analysis.pdf')))", 
                   showResult = FALSE)
# conditionalPanelWithCheckbox(
#   labelString = 'Principles of Bayesian analysis', 
#   html = HTML('<img src="www/bayes decision analysis.pdf" 
#       alt="bayes"  width="4200" height="4200">')
# , initialValue = FALSE
#   
# )
```
