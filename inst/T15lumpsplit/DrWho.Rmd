...
conditionalPanelWithCheckboxPDF(
  ...
  #html=withMathJax(shiny::includeMarkdown(path = 'DrSplitEquation.Rmd')),
  filename='DrSplitEquation.pdf',
  #filename = 'DrSplitEquation.Rmd',
  #html='',
  cbStringId='DrSplitEquation'
)
```
...
conditionalPanelWithCheckboxPDF(
  ...
  filename='DrLumpEquation.pdf',
#    html=withMathJax(shiny::includeMarkdown(path = 'DrLumpEquation.Rmd')),
  cbStringId='DrLumpEquation'
)
```
