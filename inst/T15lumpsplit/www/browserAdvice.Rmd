...
output$browserAdvice = renderUI({
  ...
  #if(! (input$isSafari ) )
  if((input$isChrome ) )
    text =  HTML("ADVICE: Please use Safari or Firefox as your browser for better PDF displays. <br>(Or if using Chrome install a PDF plugin.)  IE has not been tested.")
