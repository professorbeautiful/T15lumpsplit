 ...
 To deploy:
 The most recent installation of the package must be with .installFromGithub().
 Also view https://community.rstudio.com/t/failing-to-deploy-shinyapp-depending-on-bioconductor-packages/6970

Child chunks may not have chunk names or content, not even a comment.
Installing from github you get a warning.
But then deploying bombs with a mysterious message, can't fine the temp file path.
