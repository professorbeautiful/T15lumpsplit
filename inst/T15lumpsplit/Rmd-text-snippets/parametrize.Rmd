...
###	If **the sample size is fixed by the study's design** at 100,  
...
###	If the **two bottom margins are fixed by the study's design**,  
...
###	If **both margin counts are fixed** by the study's design,  
