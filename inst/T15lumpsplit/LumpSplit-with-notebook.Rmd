...
<a name='debugging'>**Debugging aid**</a>
...
The module begins with a dilemma, a small two-by-two table counting responding and nonresponding patients for two groups labeled D and L. Response rate is very high in  group D, very low in group L, but most of the patients are in L. The dilemma: to decide whether to pursue "personalized medicine" for group D, how informative is group L? 


This example is used as a jumping off point for individual investigations into a cluster of connected statistical concepts (thus a web) important for data scientists. The connected topics are listed below. Those students interested in technical details of derivations or coding have links at hand for relevant documents.
