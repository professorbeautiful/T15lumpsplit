...
rotateMe = function(html) {
  HTML(paste("<span class='rotateMe'>",
             html, "</span>" 
  ))
}
...
panelOfData = div(
  ...
  conditionalPanel(
    ...
    splitLayout("", "Group 'D'", "Group 'L'" ),
    splitLayout(div(br(),br(),
                    rotateMe( "<b>R</b>esponders" 
                    )),
                numericInput('mRD', 'mRD', DLdata[1,1]),
                numericInput('mRL', 'mRL', DLdata[2,1])
    ),
    splitLayout(div(br(),br(),
                    rotateMe( "<b>N</b>onResponders"
                    )),
...
output[['navTOCid']] <- renderUI({
  list(checkboxInput(cbInputId, 
                     strong(em("show/hide outline of topics")), value=FALSE),
