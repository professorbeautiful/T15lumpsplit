...
output$empBayeslogitRatios = renderPlot({
  ...
  plot(range(logitRatios)*1.05, 0:1, col='white',
       xlab= '', ylab='', axes=F,
       cex=2)
  axis(1, cex=2)
#  axis(2, at = 0:1, labels = c("raw", "EB shrunk"), lwd = 0)
  ...
  axis(3, cex=2)
 # title(
  mtext(text = 'log of odds ratios: "split" (raw) estimates', 
...
To apply this method for our data, we can use the 
