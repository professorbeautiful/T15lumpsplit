...
#### : Sidebar:  `r actionButton(class='sidebar', inputId='showconditionalProbabilityModel.Rmd', label =  'NOTATIONS for conditional probability' )`  <!-- #title -->
```{r}
          
observe( {
  if(!is.null(input$showconditionalProbabilityModel.Rmd) ) {
    if(input$showconditionalProbabilityModel.Rmd > 0) {
        showModal(modalDialog(title="NOTATIONS for conditional probability", easyClose = T,
                               footer=modalButton('OK'),
                              inclRmd('conditionalProbabilityModel.Rmd')))
    }
  }
}
)
...
# Estimating Pr(R | D) 4 ways <!-- #title -->


* [Dr.Lump and Dr.Split: have opinions!](#LumpOrSplit) 
...
## <a name='section-LumpOrSplit'>Simple "Lump" and "Split" <br>estimates of $Pr(R ~|~ D)$ </a> <!-- #title -->
