...
```{r UI_begins}
require(shinyBS)
source('gitbranch.txt')
```
*Package:T15lumpsplit  `r packageVersion('T15lumpsplit')`  `r packageDate('T15lumpsplit')` Branch: `cat gitbranch`  <br>  Author: Roger Day <br> An interactive "shiny" app. Visit [statisticsbeautiful](https://www.youtube.com/@statisticsbeautiful) for videos.*
