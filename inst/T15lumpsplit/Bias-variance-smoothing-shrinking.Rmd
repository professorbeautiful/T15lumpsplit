...
invisible( {
  require(shinyjs);
  shinyjs::useShinyjs(rmd=TRUE, debug=TRUE, html = TRUE)
  #shinyjs::useShinyjs()
})
...
observe(x = {print(cookieRetrieved <<- input$cookieinput)})
