...
## Simple "Lump" and "Split" <br>estimates of $Pr(R ~|~ D)$ <!-- #title -->
...
### <a name='section-ClassicalTest'> Who's right? Choose! Classical test</a> <!-- #title -->

A time-honored but fading technique is  
to use a classical hypothesis test,  
to guide which of two analyses "Lump" or "Split", to present.  
Here the hypothesis to be tested is 
"$X_{DL}$ is independent of Y";  
the response rate of D patients does not differ from L patients.  
Then, depending on the hypothesis test result,  
