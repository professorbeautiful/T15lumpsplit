...
* If the one left out is a *responder*, $penalty$ =  $(1-prediction)^2$.  
* If the one left out is a *non-responder*, $penalty$ =  $prediction^2$.  
...
output$tableOfEstimates = 
  ...
  # (print(x))
   ...
   x = formatStyle(x, columns = 0, 
                   #fontWeight=styleRow(1, 'bold'), #border=5,
                   color=styleRow(1:5, 
                                  values=c('red','blue',
                                          testresultColor,
                                          'green','green')),  
