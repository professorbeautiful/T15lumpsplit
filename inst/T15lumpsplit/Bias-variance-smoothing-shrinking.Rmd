...
output$fisherResult = renderUI({
  analysisName = 'panelOfBifurcation'
  source(analysisReactiveSetup_DTC, local=TRUE)
...
```{r fisherResultDTC}
jumpList_DTC = c(jumpList_DTC, panelOfBifurcation='panelOfBifurcation')
source('analysisInitialSetup_DTC.R', local=TRUE); a(name=paste0('section-a_', 'panelOfBifurcation') )
...
fluidRow(
  ...
  column(5,
         br(),
         dataTableComponent(analysisName='panelOfBifurcation')
))
