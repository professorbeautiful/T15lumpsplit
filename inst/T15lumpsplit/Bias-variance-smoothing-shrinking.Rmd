...
require(shinyBS)
```
*Package:T15lumpsplit  `r packageVersion('T15lumpsplit')`  `r packageDate('T15lumpsplit')`   <br>  Author: Roger Day <br> A "shiny" app. Visit [statisticsbeautiful](https://www.youtube.com/@statisticsbeautiful)*
