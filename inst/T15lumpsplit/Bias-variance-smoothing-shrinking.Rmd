...
```{r}
go_to_whoMixturePlot =  function(){
  anchorName = paste0('a_', 'whoMixturePlot')
  linktext = paste0('▸ ', jumpList_DTC[['whoMixturePlot']]) 
  thisNumber = which(names(jumpList_DTC) == 'whoMixturePlot')
  IdThisLinkin = paste0('linkinLink', thisNumber)
  onclickAction = paste0(IdThisLinkin, linktext)
...
Revisit the prior section: `r go_to_whoMixturePlot()`
