...
A  patient who gets a good response has $Y=R$;  
if it's a bad response, that's  $Y=N$,  $N$ for non-responding.
...
Which subgroup a patient belongs to is a *"feature"*  we call  
$X_{DL}$, with possible values $D$ or $L$. 

This feature $X_{DL}$ might be a valuable biomarker.   
