...
One test frequently performed to test independence  
in a 2x2 table like this one is the *Fisher exact test*.  
...
60%...  and WE COMPLETELY IGNORE THE DATA FOR THE "L" PATIENTS!  
...
output$fisherResult = renderUI({
  ...
  if(Pvalue < 0.05) # pick Split
    theText = paste(theText,
      "That's less than 0.05. <br> So the test concludes 'Dr. Split is right'. <br> 
      We go with the Dr. Split estimate:<br><br>
      Our guess:  <em><strong>Pr(R|D) =  ", 
      rValues$estimates_Lump_Split[['split']],
      '</em></strong>')
  else
    theText = paste(theText,
      "That's greater than 0.05. <br>So the test concludes 'Dr. Lump is right'. <br> 
            We go with the Dr. Lump estimate:<br><br>
      Our guess:  <em><strong>Pr(R|D) =  ", 
      rValues$estimates_Lump_Split[['lump']],
      '</em></strong>')
  div(HTML(theText))
})
