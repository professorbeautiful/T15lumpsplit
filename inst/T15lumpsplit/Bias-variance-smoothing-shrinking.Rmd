...
#                              src='Reproducibility-lump-split-page-1.pdf')
#                  ),
#                  initialValue=FALSE
#                )
...
# )
# conditionalPanelWithCheckbox(
#   labelString = 'bias-variance axis ',
#   html = 
...
wellPanel(
  checkboxInput('Reproducibility', 
                strong(em(showhideString('The bias-variance axis', FALSE)
                )),
                value=FALSE),
  conditionalPanel(condition = paste0('input.', 'Reproducibility'),
                   tags$iframe(style="height:600px; width:100%",
                               src="Reproducibility-lump-split-page-1.pdf") )
  #### HERE ####
)
