...
What if D and L represent dark hair color and light hair color?  
"Dr. Who" may be highly skeptical that this $X_{DL}$  
really affects response,  
and express this by choosing a prior odds that favors Dr. Lump  over Dr. Split. 
##	Strong prior belief that the feature $X_{DL}$ is important <!-- #title -->

What if D and L represent two alleles of a  
gene believed to affect this drug's pharmacodynamics?  
...
"Dr. Who" can express choosing a prior odds  
...
Initially the extra 99 feature are all "null hypotheses".  
