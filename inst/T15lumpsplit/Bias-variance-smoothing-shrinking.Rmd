...
The estimated variance is `r output$tauEstEB = renderText(rValues$tauEstimateEB); textOutput('tauEstEB', inline=TRUE)`. (The value that generated the data is `r   thisTauTrueID_text = paste0(get_thisTauTrueID(currentBDCnumber), '_text')
output[[thisTauTrueID_text]] = renderText(input[[thisTauTrueID]]); textOutput(thisTauTrueID, inline=TRUE)`) .
