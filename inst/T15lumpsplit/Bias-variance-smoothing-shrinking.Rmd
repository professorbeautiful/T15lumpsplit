...
whichExist = (sapply(analysisReactiveSetup_options, file.exists))
analysisReactiveSetup = (analysisReactiveSetup_options[whichExist][1])
```
...
output$plotLumpSplitPoints = renderPlot(
  height = 300, {
    analysisName = 'plotLumpSplitPoints'
    source(analysisReactiveSetup, local=TRUE)
    cat('plotLumpSplitPoints: ', paste(thisData), '\n')
    cat('plotLumpSplitPoints: ', paste(getDLdata(analysisName)), '\n')
