...
assembleTQAnswers = reactive({
  lastTQNumber = nextNumber(sequenceType = "TQ") - 1
...
saveComments = reactive({
  ...
  commentTextFile <<- file(paste0('comments.',
                                 Sys.info()["user"],
                                 '.txt'))
  commentHTML <<- #capture.output(
    pre(paste(commentText, collapse='\n')) 
    #)
  print(commentHTML)
  commentHTMLFile <<- file(paste0('comments.',
                                 Sys.info()["user"],
                                 '.html'))
  writeLines(commentText, commentTextFile)
  #writeLines(commentHTML, commentHTMLFile)
  close(commentTextFile)
  close(commentHTMLFile)
  #browseURL(commentTextFile)
  return(commentHTML)
})
...
```{r}
#commentHTML <<- ''
#actionButton("saveComments", 'save your QA and TQ comments')
conditionalPanelWithCheckbox(
  labelString = 'See your comments here',
  #filename = NULL, 
...
# conditionalPanel('input.saveComments',
#   uiOutput('saveCommentsPanel')
# )
