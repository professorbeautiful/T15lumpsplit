...
The challenge: decide whether to treat the "$D$ patients" -- or more modestly, to decide whether to put resources into studying the treatment further for "$D$ patients".
...
**Dr. Lump* disagrees!   “No no, I am sure that this so-called "biomarker" $X_{DL}$  is irrelevant! I will ignore it, and look at the data for all the patients.” 
