...
output$estimateTable = 
  ...
  result = c( #xtable::xtable(data.frame(
      LumpRawMean,
      SplitRawMean,
      posterior.mean.l,
      posterior.mean.s,
    ...
    #xtable_result = round(result, digits=2) 
    #names(result) = paste0('X', 1:7)  # niceColHeader
    #print(xtable_result)
    # withMathJaxresult <<- (withMathJax(result))
    # withMathJaxresult
    ## TODO: use the conditional posterior means instead.
    ##  i.e. add in the pseudocounts.
#    tableOfEstimates()
   withMathJax(paste0(' \\begin{array}{*{3}{c}}',
paste(niceColHeader, collapse='&'),
'\\\\',
paste(round(result, digits=2) , collapse="&"),
'\\end{array}') )
})

div(uiOutput('estimateTable'),
