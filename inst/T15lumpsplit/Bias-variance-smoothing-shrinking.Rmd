...
probability that the patient responds to treatment  
given that the patient is a $D$ patient.  
We can see this conditional probability written different ways,  
some long, some short,  
using the vertical bar or the dot to say *"conditional on"*:
