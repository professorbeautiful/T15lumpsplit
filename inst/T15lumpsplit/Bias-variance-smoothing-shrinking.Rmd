...
saveComments <<- function() {
  ...
  commentTextFile = file(paste0('comments.',
                                 Sys.info()["user"],
                                 '.txt'))
  commentHTML = capture.output(pre(commentText))
  print(commentHTML)
...
```{r}
actionButton("saveComments", 'save your QA comments')
observeEvent(input$saveComments, {
  saveComments()
  commentFile = paste0('answers.',
                                 Sys.info()["user"],
                                 '.txt') 
})
```
