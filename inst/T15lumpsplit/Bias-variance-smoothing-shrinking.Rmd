...
## Estimating Pr(R | D), several ways <!-- #title -->


* [Dr.Lump and Dr.Split have opinions about $Pr(R ~|~ D)$ !](#LumpOrSplit) 
* [Who's right? Gotta choose! Classical significance test](#ClassicalTest)
* [Bayes mixture:  "Dr. Who"](#Bayes_mixture)
* [Bayes joint prior, logit scale](#Bayes_joint_prior).  
* [Cross-validation to optimize](#Cross_validation)
* Approaches used in the famous ECMO data set. (ToDo)


### <a class='threesharps' name='section-LumpOrSplit'>Dr.Lump and Dr.Split reach different conclusions </a> <!-- #title -->
...
### <a class='threesharps' name='section-Variance-Bias'> Variance and bias refresher</a> <!-- #title -->
...
### <a class='threesharps' name='section-ClassicalTest'> Who's right? Dr.Who's gotta choose! Classical significance test</a> <!-- #title -->
...
### <a class='threesharps' name='section-Bayes_mixture'> Bayes mixture of smooth "Lump" and smooth "Split" prior beliefs</a> <!-- #title -->
...
###  <a class='threesharps' name='section-Cross_validation'>Optimizing the mixture with cross-validation </a><!-- #title -->
