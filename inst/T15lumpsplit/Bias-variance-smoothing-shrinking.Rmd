...
bigDataComponent()
observeEvent( input[[get_thisTauTrueID()]], {
  tauTrue = input[[get_thisTauTrueID()]]
...
output$oddsratioplot = renderPlot({
  ...
  logoddsratioSDs = sqrt(rValues$logoddsratiovariances)
  points(logoddsratios, col='red', type='h',
       logoddsratioSDs * par('usr')[4]/
        max(logoddsratioSDs) *0.3)
  points(logoddsratioSDs[1], col='green', type='h',
       logoddsratioSDs[1] * par('usr')[4]/
        max(logoddsratioSDs) *0.3,
       lwd=2)
...
have sampling variances roughly equal to the sums of reciprocals of the counts. 
