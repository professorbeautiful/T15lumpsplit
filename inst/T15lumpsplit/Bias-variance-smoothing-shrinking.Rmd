...
##	Strong prior belief that feature $X_{DL}$ is implausible <!-- #title -->
...
You can experiment with the effects of prior belief  
by choosing such a value here: 
...
interject prior belief on the Lump-versus-Split axis?
