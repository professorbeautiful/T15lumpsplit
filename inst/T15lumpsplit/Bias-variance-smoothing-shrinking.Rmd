...
are fundamentally different.   Since the question is what to do with $D$ people,  
...
Lumping gives an answer with *low variance*  
...
Splitting gives an answer with high variance ($N$=6 initially)  
but *low bias*--  
