...
###  Optimizing the mixture with cross-validation <!-- #title -->
...
where the $prediction$ is based on the rest of the sample.
...
The optimal weighting is at 0.73 for Split 0.27 for Lump. 
