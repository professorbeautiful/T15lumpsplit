...
estimates = observeEvent(
  rValues$DLdata[[getDTCnumber('plotLumpSplitPoints') ]],
  {
  source('analysisReactiveSetup.R', local=TRUE)
  thisData = rValues$DLdata[[getDTCnumber('plotLumpSplitPoints') ]]
...
output$plotLumpSplitPoints = renderPlot(
  height = 300, {
    ...
    plotPlightPdarkPosterior(
      DLdata=rValues$DLdata[[mapAnalysisToDTCnumber[analysisName]]],
      showPrior = FALSE, 
