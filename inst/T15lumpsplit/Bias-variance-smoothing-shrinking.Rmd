...
the probability that the patient responds to treatment  
given that the patient is a $D$ patient.  


```{r}
conditionalPanelWithCheckbox('Other ways people write conditional probability $Pr(R|D)$', filename = 'conditionalProbabilityModel.Rmd')
``` 
