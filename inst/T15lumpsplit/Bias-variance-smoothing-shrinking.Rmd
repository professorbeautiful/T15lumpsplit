---
title: "Lumping and splitting.  <br>Bias and variance. <br>Individuals and groups-- --\"Borrowing strength\""
resource_files:
- www/zoomAdvice.Rmd
...
You are YOU! Right!  Nobody else like you.  
But other people are kind of like you.  
We'll get back to that in a moment.

In science, advances often proceed by "splitting":  
things that seem initially the same are classified as different.  
The classification may be a tentative distinction,  
until it proves to be useful. 
...
So, we split birds and bats,  
but we lump bats and whales because they are both mammals.  
At least in this case, for some purposes,  
lumping supercedes splitting.
...
better splitting  
can cure cancer patients.

AND... sometimes you don't have to choose.  
You can do better than noth.
...
Of them, only `r sum(DLdataOriginal["R", ])` respond.  
The outcome we call $Y$.  
A responding patient has $Y=R$; non-reponding, $Y=N$.

That is discouraging. 

But there is a subgroup of just `r sum(DLdataOriginal[ , "D"])` in which `r sum(DLdataOriginal["R","D"])` patients respond,  
...
-- so imporant that the $D$ people and the $L$ people  
