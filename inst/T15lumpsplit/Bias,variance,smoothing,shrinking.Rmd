...
output$postmean.p = renderText(
  paste0(
    round(digits=2, rValues$bivariateNormResults$postmean.p[1]),
    ' (95% confidence interval: ', 
    round(digits=2, rValues$bivariateNormResults$confints.p[1 , 1]),
    '-',
    round(digits=2, rValues$bivariateNormResults$confints.p[2 , 1]),
    ')'
  )
)
```
