...
Finally, Pr(R|D) marginalized over Pr(R|L) has posterior mean =  
`r output$postmean.p = renderText(paste0('(', paste0(round(digits=2, rValues$bivariateNormResults$postmean.p), collapse=", "), ')')); span(textOutput('postmean.p'))`  .
