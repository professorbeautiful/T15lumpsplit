...
actionLink('biasVariancePicture', label=HTML('<font color=blue>here.</font>'))
observeEvent({input$biasVariancePicture},
             linkout('Reproducibility-lump-split-page-1.pdf')
)
```
