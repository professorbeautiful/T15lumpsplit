...
The module *"Bias, variance, smoothing, and shrinking"* begins with the *"lump versus split dilemma"* sub-module, in the context of a study treating patients and recording responses.  The dilemma: in deciding whether to pursue "personalized medicine" for one small group of patients, how should we use the data from patients in other groups (if at all)? 
